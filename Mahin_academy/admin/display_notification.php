...
if(!$rr)
{
echo "<h2 style='color:red'>Result in not published yet !!!</h2>";
}
else
{
?>
<h2 style="color:#00FFCC">All Results</h2>

<table class="table table-bordered">
	<tr>
		<th colspan="7"><a href="index.php?page=add_notice">Add New Result</a></th>
	</tr>
	<Tr class="success">
		<th>Sr.No</th>
		<th>Semester</th>
